...
ETEXI
...
#ifdef CONFIG_QTRACE_CORE
    {
        ...
        .args_type  = "enabled:b",
        .params     = "enabled",
        .help       = "Enable/Disable all available QTrace modules, as soon as a safe execution state is reached",
        .mhandler.cmd = qtrace_qmp_qtrace_enable,
    },

STEXI
@item qtrace-enable @var{enabled}
@findex qtrace-enable

Enable or disable all available QTrace modules: system call tracer and
...
ETEXI

    {
        ...
        .args_type  = "",
        .params     = "",
        .help       = "Get the current state of available QTrace modules",
        .mhandler.cmd = qtrace_qmp_qtrace_query,
    },
...
Get the current state of all the QTrace modules available.
ETEXI
#ifdef CONFIG_QTRACE_SYSCALL
    {
        .name       = "qtrace-enable-tracer",
        .args_type  = "enabled:b",
        .params     = "enabled",
        .help       = "Enable/Disable QTrace tracer module, as soon as a safe execution state is reached",
        .mhandler.cmd = qtrace_qmp_tracer_enable,
    },

STEXI
@item qtrace-enable-tracer @var{enabled}
@findex qtrace-enable-tracer

Enable or disable QTrace syscall tracer module. Remember tracer state is NOT
switched immediately, but only when a suitable execution state is reached.
ETEXI

    {
        .name       = "qtrace-query-tracer",
        .args_type  = "",
        .params     = "",
        .help       = "Get QTrace tracer module state",
        .mhandler.cmd = qtrace_qmp_tracer_query,
    },

STEXI
@item qtrace-query-tracer
@findex qtrace-enable-tracer

Get QTrace syscall tracer state.
ETEXI
#endif  /* CONFIG_QTRACE_SYSCALL */

#ifdef CONFIG_QTRACE_TAINT
    {
        .name       = "qtrace-enable-taint",
        .args_type  = "enabled:b",
        .params     = "enabled",
        .help       = "Enable/Disable QTrace taint-tracker",
        .mhandler.cmd = qtrace_qmp_taint_enable,
    },

STEXI
@item qtrace-enable-taint @var{enabled}
@findex qtrace-enable-taint

Enable or disable QTrace taint-tracker module.
ETEXI

    {
        .name       = "qtrace-query-taint",
        .args_type  = "",
        .params     = "",
        .help       = "Get QTrace taint-tracker state",
        .mhandler.cmd = qtrace_qmp_taint_query,
    },

STEXI
@item qtrace-query-taint
@findex qtrace-enable-taint

Get QTrace taint-tracker state.
ETEXI
#endif  /* CONFIG_QTRACE_TAINT */
#endif  /* CONFIG_QTRACE_CORE */
