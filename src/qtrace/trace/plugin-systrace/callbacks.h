...
#ifndef SRC_QTRACE_TRACE_PLUGIN_SYSTRACE_CALLBACKS_H_
#define SRC_QTRACE_TRACE_PLUGIN_SYSTRACE_CALLBACKS_H_
...
#endif  // SRC_QTRACE_TRACE_PLUGIN_SYSTRACE_CALLBACKS_H_
